...
.NOTES
    ...
    2.1 2018.07.24 - bjs
        ...
        Change Email Server, EmailTo, EmailFrom from Mandatory to Not required and added as params
			...
			TRY
			{
				...
				IF ($GroupName)
				{
					...
					if ($ADModule)
					{
						...
						$Members = $members | get-adcomputer   | Select-Object -Property *,@{ Name = 'DN'; Expression = { $_.DistinguishedName } }
					...
					If ($Changes -or $AlwaysReport)
					{
	                    ...
	                    $emailParams = @{
                        To = $ManagerEmail
                        From = "kit-noreply@kidney-mn.com"
